...
main_sheet = f"{DIR_NAME.parent}/データベース/07_sequence_baseline.xlsx"
...
df_for_output.to_csv(
    f"{DIR_NAME.parent}/データベース/data/calcd_DB07_baselinesequence.csv",
    encoding="utf-8-sig", index=False)
os.startfile(rf"{DIR_NAME.parent}/データベース/07_sequence_baseline.xlsx")
